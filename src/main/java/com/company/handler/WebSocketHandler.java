...
public class WebSocketHandler extends TextWebSocketHandler implements InitializingBean {
	...
	protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
		...
		// Json객체 → Java객체
		// 출력값 : [roomId=123, messageId=null, message=asd, name=천동민,
		// email=cheon@gmail.com, unReadCount=0]
		...
		// 채팅 메세지 입력 시
			...
			TextMessage textMessage = new TextMessage(
					chatMessage.getNickname() + "," + chatMessage.getUserid() + "," + chatMessage.getMessage());
